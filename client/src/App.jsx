    ...
    <div>
      ...
      {isOpen && (
        <div className="chatbot-box">
          ...
          <div className="chat-input" style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
            <button onClick={startListening} title="Speak" style={{ background: 'black', padding: '8px', borderRadius: '8px' }}>
              <Mic
                color="white"
                size={24}
            ...
            <input
              ...
              style={{ flex: 1 }}
            />
            <button style={{ background: 'black' }} onClick={sendQuestion}>Send</button>
          </div>
        </div>
      )}
    </div>
